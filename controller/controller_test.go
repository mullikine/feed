...
func TestUpdaterIsUpdatedOnK8sUpdates(t *testing.T) {
	...
	var tests = []struct {
		...
		{
			"ingress name not set in ingress or config",
			createIngressesFixture(ingressHost, ingressSvcName, ingressSvcPort,
				map[string]string{
					ingressAllowAnnotation:      "",
					stripPathAnnotation:         "false",
		...
		{
			"ingress with ingress name not set and config set to default",
			createIngressesFixture(ingressHost, ingressSvcName, ingressSvcPort,
				map[string]string{
					ingressAllowAnnotation:      "",
					stripPathAnnotation:         "false",
		...
		{
			"ingress with ingress name set to default and config set to default",
			createIngressesFixture(ingressHost, ingressSvcName, ingressSvcPort,
				map[string]string{
					ingressAllowAnnotation:      "",
					stripPathAnnotation:         "false",
