...
func (g *gclb) attachToFrontEnds() error {
	...
	for _, frontend := range clusterFrontEnds {
		...
		if attached {
			...
			err := g.instanceGroupService.AddInstance(g.instance, frontend.Name)
			if err != nil {
...
func (g *gclb) findFrontEndInstanceGroups() ([]*compute.InstanceGroup, error) {
	groups, err := g.instanceGroupService.List(g.instance.project, g.instance.zone)
	if err != nil {
...
func (g *gclb) isAlreadyAttached(groupName string) (bool, error) {
	instances, err := g.instanceGroupService.ListInstances(g.instance.project, g.instance.zone, groupName)
	if err != nil {
...
func (g *gclb) getInstance() (*instance, error) {
	...
	instanceGetResult, err := g.instanceService.Get(project, zone, name)
	if err != nil {
